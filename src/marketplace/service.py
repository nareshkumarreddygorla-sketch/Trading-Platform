...
_SEED_STRATEGIES = [
    StrategyListing(
        ...
        author="TradingPlatform",
        category=StrategyCategory.BREAKOUT,
        risk_level=StrategyRisk.MEDIUM,
    ...
    StrategyListing(
        ...
        win_rate=68.0,
        total_return_pct=32.8,
        tags=["rsi", "mean_reversion", "bollinger", "low_risk"],
        is_published=True,
    ),
    StrategyListing(
        listing_id="mkt-003",
        strategy_id="preset_trend_following",
        ...
        tags=["ema", "trend", "adx", "crossover"],
        is_published=True,
    ),
    StrategyListing(
        listing_id="mkt-004",
        strategy_id="preset_vwap_reversion",
    ...
    StrategyListing(
        listing_id="mkt-005",
        strategy_id="preset_opening_range_breakout",
        name="Opening Range Breakout",
        description="Trade breakout of first 15-minute opening range with ATR confirmation filter.",
        author="TradingPlatform",
        category=StrategyCategory.BREAKOUT,
        risk_level=StrategyRisk.HIGH,
        indicators=["ATR", "Opening Range"],
        ...
        tags=["orb", "intraday", "breakout", "opening_range"],
        is_published=True,
    ),
    StrategyListing(
        listing_id="mkt-006",
        ...
        author="TradingPlatform",
        category=StrategyCategory.ML_AI,
        risk_level=StrategyRisk.MEDIUM,
        indicators=["XGBoost", "LSTM", "Transformer", "RL-PPO", "FinBERT"],
        ...
        tags=["ai", "ml", "ensemble", "deep_learning", "premium"],
        is_published=True,
    ),
]
...
class MarketplaceService:
    ...
    def list_strategies(
        ...
        risk_level: StrategyRisk | None = None,
        ...
        if search:
            q = search.lower()
            results = [
                l for l in results if q in l.name.lower() or q in l.description.lower() or any(q in t for t in l.tags)
            ]
        sort_map = {
    ...
    def subscribe(
        self, user_id: str, listing_id: str, auto_trade: bool = False, capital: float = 0.0
    ) -> StrategySubscription | None:
    ...
    def add_review(self, listing_id: str, user_id: str, rating: float, comment: str) -> StrategyReview | None:
        ...
        return [
            {
                ...
                "win_rate": l.win_rate,
                "total_return_pct": l.total_return_pct,
