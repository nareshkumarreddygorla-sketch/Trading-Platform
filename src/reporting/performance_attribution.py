...
class PerformanceAttributionEngine:
    ...
    SECTOR_MAP = {
        ...
        "BHARTIARTL": "Telecom", "JIOFINANCE": "Telecom",
        "ADANIGREEN": "Adani Group", "ADANIPORTS": "Adani Group", "ADANIENT": "Adani Group",
    }
    ...
    def compute_full_attribution(
        ...
        """
        dimensions = ["model_id", "strategy_id", "symbol", "sector",
                       "regime", "time_bucket", "exit_reason", "side"]
    ...
    def _get_dimension_value(self, trade: Dict, dimension: str) -> Optional[str]:
